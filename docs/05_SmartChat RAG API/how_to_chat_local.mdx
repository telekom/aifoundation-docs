...
body = {
  ...
  "config": {
    ...
    "globalContext": False,
    "activeFiles": [uploaded_file["fileId"] for uploaded_file in uploaded_files],  # you can also leave empty. In that case, all files in the local context will be used for retrieval.
...
- [SmartChat RAG Overview](./smartchat-overview) - Overview of SmartChat RAG API
- [Global KB Chat Guide](./global_chat_guide) - Chat using global knowledge base
- [API Reference](./eRAG%20API%20Reference) - Complete API documentation