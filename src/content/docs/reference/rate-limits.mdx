...
| **Representative RPM** † | 300 | 1,000 | 3,000 |
...
:::note
**Preview models** (the Test catalog, e.g. `Gemma 4`) use *dynamic* rate limits rather than fixed RPM/TPM. Telekom may adjust or restrict preview-model usage at any time without prior notice.
:::
