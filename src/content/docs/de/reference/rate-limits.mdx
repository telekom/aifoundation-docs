...
:::note
**Preview-Modelle** (Test-Katalog, z. B. `Gemma 4`) nutzen *dynamische* Rate-Limits anstelle fester RPM/TPM-Werte. Die Telekom kann die Nutzung von Preview-Modellen jederzeit ohne vorherige Ankündigung anpassen oder einschränken.
:::
