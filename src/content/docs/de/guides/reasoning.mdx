...
- Welche Modelle Reasoning-Steuerung unterstützen
...
- [Funktionsaufrufe](/de/guides/function-calling) — Reasoning-Modelle mit externen Tools verbinden
