...
- Ein visionfähiges Modell (siehe [Verfügbare Modelle](/getting-started/models))
:::
...
Die aktuelle Liste finden Sie unter [Verfügbare Modelle](/getting-started/models).


## Nächste Schritte

- [Visual RAG](/guides/visual-rag) — Dokumente mit Text- + Bildverständnis indizieren und abrufen
- [Function Calling](/guides/function-calling) — Modelle mit externen Tools verbinden
- [Streaming](/guides/streaming) — Antworten für bessere UX streamen
