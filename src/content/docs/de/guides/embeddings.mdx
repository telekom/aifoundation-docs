...
- **[LangChain-Integration](/integrations/langchain)** — Embeddings mit LangChain für RAG verwenden
- **[LlamaIndex-Integration](/integrations/llama-index)** — Embeddings mit LlamaIndex für RAG verwenden
