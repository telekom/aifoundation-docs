---
title: "Fine-Tuning"
description: "Mistral- und Llama-Modelle mit eigenen Daten via LoRA oder DPO über die AI Foundation Services Fine-Tuning API anpassen."
---
...
- Ein API-Schlüssel mit aktiviertem Fine-Tuning (kontaktieren Sie **AlFoundation@t-systems.com**)
...
### Fine-Tuning-Aufträge auflisten
...
- [Chat Completions](/de/guides/chat-completions) — Ihr fine-tuned Modell verwenden
