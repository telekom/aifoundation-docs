...
description: "Mistral- und Llama-Modelle mit eigenen Daten via LoRA oder DPO über die AI Foundation Services Fine-Tuning API feinabstimmen."
---
...
- [Chat Completions](/de/guides/chat-completions) — Ihr feinabgestimmtes Modell verwenden
- [Verfügbare Modelle](/de/getting-started/models) — Alle verfügbaren Modelle durchsuchen
