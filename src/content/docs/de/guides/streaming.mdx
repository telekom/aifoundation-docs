---
title: "Streaming"
description: "LLM-Antworten Token für Token via Server-Sent Events auf AI Foundation Services streamen — für geringere Latenz und besseres Nutzererlebnis."
---
...
- [Chat-Vervollständigungen](/de/guides/chat-completions) — Nicht-streamende Chat-API-Nutzung
- [Function Calling](/de/guides/function-calling) — Tools mit der API definieren und verwenden
- [Asynchrone Anfragen](/de/guides/asynchronous-requests) — Warteschlangenbasierte Verarbeitung für Batch-Workloads
- [Fehlercodes](/de/reference/error-codes) — API-Fehler behandeln
