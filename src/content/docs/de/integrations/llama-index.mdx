...
description: "RAG-Anwendungen und Chat-Engines mit LlamaIndex aufbauen, indem der OpenAI-kompatible Client auf AI Foundation Services zeigt."
---
...
- **[LangChain-Integration](/de/integrations/langchain)** — Alternatives RAG-Framework
