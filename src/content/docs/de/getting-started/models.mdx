...
description: "Überblick über LLMs, Vision-, Embedding- und Audiomodelle auf AI Foundation Services sowie Abruf der aktuellen Modellliste per API."
---
...
- **Open-Source-Modelle** werden von T-Systems auf der **T-Cloud** in Deutschland betrieben. Die Daten werden innerhalb der EU/EWR verarbeitet, nicht gespeichert, sind weder für die Telekom noch für Dritte einsehbar und werden nicht zum Modelltraining genutzt.
...
Die vollständige Aufschlüsselung des Datenverarbeitungs-Modells in zwei Kategorien finden Sie unter [Enterprise Trust](/de/reference/enterprise-trust).
