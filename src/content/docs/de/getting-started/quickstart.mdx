...
- **[Chat Completions](/de/guides/chat-completions)** — Detaillierte Anleitung mit Streaming, Parametern und mehr
- **[LangChain](/de/integrations/langchain)** — AIFS mit LangChain für RAG verwenden
- **[Llama Index](/de/integrations/llama-index)** — AIFS mit LlamaIndex für RAG verwenden
