...
- **Open-source models** are operated by T-Systems on the **T-Cloud** in Germany. Data is processed inside the EU/EEA, is not stored, is not viewable by Telekom or third parties, and is not used for model training.
...
See [Enterprise Trust](/reference/enterprise-trust) for the full two-category data-handling breakdown.
