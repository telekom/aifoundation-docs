...
description: "Install and configure the Continue plugin for Visual Studio Code with chat, inline edits, autocomplete, and coding agents on AI Foundation Services."
---
