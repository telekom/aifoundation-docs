...
For a complete list with pricing, see the [Plans & Pricing](/plans-page) page.
...
**Key fields:**
- **model_type** — `LLM`, `Embedding`, `NLP` (audio), or `Vision`
...
- **deployment_region** — Where the model is hosted (e.g., `otc-germany`)
...
| **Vision** | Qwen2.5-VL-72B-Instruct, Gemini 2.5 Flash | Image analysis, multimodal chat |
| **Audio/NLP** | whisper-large-v3 | Speech-to-text, translation |
